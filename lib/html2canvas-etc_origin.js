...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["html2canvas_etc"] = factory();
	else
		root["html2canvas_etc"] = factory();
})(this, function() {
    ...
    _createClass(Logger, [{
        ...
        value: function log() {
            if (window.console && window.console.log) {
                ...
                Function.prototype.bind.call(window.console.log, window.console).apply(window.console, [Date.now() - this.start + 'ms', this.id ? 'html2canvas_etc (' + this.id + '):' : 'html2canvas_etc:'].concat([].slice.call(args, 0)));
            }
        }
        ...
        value: function error() {
            if (window.console && window.console.error) {
                ...
                Function.prototype.bind.call(window.console.error, window.console).apply(window.console, [Date.now() - this.start + 'ms', this.id ? 'html2canvas_etc (' + this.id + '):' : 'html2canvas_etc:'].concat([].slice.call(args, 0)));
            }
        }
    }]);
...
//        }
        ...
        xhr.open('GET', proxy + encodeURIComponent(src) );
